(function() {
  ...
  var e,
    ...
    l = function(t) {
      let l = this.parentNode.parentNode,
    ...
    var e,
      ...
      l = function(e) {
        let t = this.parentNode,
          l = t.querySelector('.icon');
        l.classList.remove('icon--black-3'), l.classList.add('icon--blue');
      },
      n = function(e) {
        let t = this.parentNode,
          l = t.querySelector('.icon');
        l.classList.add('icon--black-3'), l.classList.remove('icon--blue');
      };
    window.iconInput = {
      init: function(o) {
        ...
        s.forEach(e => {
          e.addEventListener('focusin', l, !1),
            e.addEventListener('focusout', n, !1);
        });
      },
      destroy: function() {
        let t = document.querySelectorAll(e);
        t.forEach(e => {
          e.removeEventListener('focusin', l, !1),
            e.removeEventListener('focusout', n, !1);
        });
      }
    };
  })(),
  (function() {
    ...
    function e() {
      ...
      for (let o = 0; o < e; o++) {
        ...
        } else for (let e = 0; e < a[o].length; e++) l(a[o].options[e]);
      }
    }
    function t(e, t) {
      let l = a[t];
      (l.style.display = 'none'),
        (l.options[l.selectedIndex].selected = !0),
      ...
      if (((c = document.createElement('ul')), 0 == l.selectedIndex))
        n = document.createTextNode(l.options[0].text);
      else {
        let e = l.selectedIndex;
        n = document.createTextNode(l.options[e].text);
      }
    ...
    function l(e) {
      if ('' != e.value) {
        ...
        if (
          ...
          (l.className = s + '__list-item-icon'),
      ...
      m = function(e) {
        ...
        if ('BUTTON' == t.tagName) {
          ...
          for (let e = 0; e < l.length; e++)
            l[e].classList.remove(s + '__list-item--active');
          t.classList.add(s + '__list-item--active');
          let n = e.parentNode.querySelector('SELECT'),
            o = t.getAttribute('data-value'),
            a = n.querySelectorAll('option'),
            c = a.length;
          a.forEach(e => {
      ...
      v = function(e) {
        ...
        t.forEach(t => {
          let l = t.parentNode,
            ...
            o = l.querySelector('BUTTON');
          if (n.classList.contains(s + '__list--active')) {
            let t = l.contains(e.target);
            t ||
              (n.classList.remove(s + '__list--active'),
    ...
    window.selectMenu = {
      ...
      destroy: function() {
        ...
        e.forEach(e => {
          let t = e.parentNode,
            l = t.querySelector('BUTTON'),
            n = t.querySelector('UL');
          l.remove(), n.remove(), (t.outerHTML = t.innerHTML);
        }),
